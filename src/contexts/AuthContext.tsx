        ...
        <Card className="w-full max-w-md bg-white/5 border-white/10 backdrop-blur-md">
          ...
          <CardContent>
            <Button 
              ...
              // FIX: Added !bg-white and !text-black to force high contrast
              className="w-full !bg-white hover:!bg-gray-200 !text-black font-bold h-12 shadow-lg flex items-center justify-center gap-3 transition-transform active:scale-95 border-0"
            >
              {/* Google Logo SVG */}
